...
const DopplerScanHeaderContent = () => {
  return (
    <div className="pathologyHeadContent">
      ...
      <p>
        Pathacon Diagnostics in Rajajinagar, Bangalore, is at the forefront of
        ...
        , which plays a vital role in assessing and monitoring various medical
        conditions. This sophisticated imaging technique is particularly
        ...
        is conducted with precision, safety, and efficiency.
      </p>
      <br />
    </div>
  );
...
export default DopplerScanHeaderContent;
