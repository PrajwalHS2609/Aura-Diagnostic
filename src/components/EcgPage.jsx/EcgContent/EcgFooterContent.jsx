  ...
  return (
    <div className="pathologyHeadContent">
      ...
      <p>
        ...
        <ul>
          <br />
          <h6>4. Comfort and Convenience:</h6>
          <p>
      ...
      <p>
        <ul>
          <h6> • Chest pain or discomfort</h6>
        </ul>
        <ul>
          <br />
        ...
        <ul>
          <br />
          <h6>• Irregular heartbeats or palpitations</h6>
        </ul>
        <ul>
          <br />
        ...
        <ul>
          <br />
          <h6>• Unexplained fatigue</h6>
        </ul>
      </p>
      <p>
        Additionally, if you have risk factors like diabetes, high cholesterol,
      ...
      <p>
        ...
        <ul>
          <br />
          <h6>
            • Avoid applying lotions or creams to your skin on the day of the
            test, as this can interfere with the placement of the electrodes.
          </h6>
        </ul>
        <ul>
          <br />
          <h6>
            • Inform your doctor of any medications you are currently taking, as
            some may affect your heart’s electrical activity.
          </h6>
        </ul>
      </p>
      <br />
...
export default EcgFooterContent;
