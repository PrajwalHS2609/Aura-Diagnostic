  ...
  return (
    <div className="service-headContent">
      ...
      <p>
        ...
        Ultrasound Scan in Rajajinagar, Bangalore stands as one of the most
        ...
        services to the community of Rajajinagar. Whether you're in need of a
        routine pregnancy scan or a detailed evaluation of your internal organs,
        our state-of-the-art ultrasound services ensure precise results
...
export default UltraSoundHeaderContent;
