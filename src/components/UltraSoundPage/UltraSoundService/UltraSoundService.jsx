  ...
  return (
    <div className="pathologyService">
      <PathologyServiceCard
        ...
        para="Expecting mothers in Rajajinagar, Bangalore can rely on our 3D and 4D Ultrasound Scans for routine pregnancy monitoring. These scans provide clear images of the baby, offering both emotional connection and vital insights into the pregnancy's progress."
      />
      <PathologyServiceCard
        head="Abdominal Ultrasound"
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/NT-Scan-New.png"
        para=" Our abdominal Ultrasound Scan in Rajajinagar, Bangalore helps in diagnosing conditions affecting the liver, kidneys, gallbladder, pancreas, and other internal organs. It is a vital tool for detecting abnormalities like gallstones, kidney stones, liver disease, and more."
      />
      <PathologyServiceCard
        head="Pelvic Ultrasound"
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/Anomaly-Scan.png"
        para=" For women, a pelvic ultrasound is often used to assess reproductive health and diagnose conditions such as ovarian cysts, fibroids, or other abnormalities. Our Ultrasound Scan in Rajajinagar, Bangalore provides detailed images that help in identifying and managing these conditions effectively."
      />
      <PathologyServiceCard
        head="Thyroid Ultrasound"
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/Fetal-Echo.png"
        para=" Thyroid issues are common, and our Ultrasound Scan in Rajajinagar, Bangalore offers a non-invasive way to examine the thyroid gland. This scan can help in diagnosing conditions like thyroid nodules, goiters, or thyroid cancer."
      />
      <PathologyServiceCard
