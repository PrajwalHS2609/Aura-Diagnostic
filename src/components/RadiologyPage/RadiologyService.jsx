  ...
  return (
    <div className="pathologyService">
      <PathologyServiceCard
        ...
        para="Our advanced X-ray services in Bangalore offer quick, painless imaging to diagnose fractures, infections, and more. Skilled radiologists ensure accurate interpretations for effective treatment planning."
      />
      <PathologyServiceCard
        head="Ultrasound Imaging"
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/NT-Scan-New.png"
        para="At Pathacon Diagnostics in Bangalore, we offer advanced ultrasound imaging for pregnancy monitoring and assessing internal organs, providing clear and accurate results for optimal patient care."
      />
      <PathologyServiceCard
        head=" Computed Tomography (CT) Sca"
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/Anomaly-Scan.png"
        para="Our high-resolution CT scans in Bangalore provide detailed cross-sectional images to diagnose conditions like tumors, internal injuries, and neurological disorders, ensuring minimal radiation exposure with advanced imaging techniques."
      />
      <PathologyServiceCard
        head="Magnetic Resonance Imaging (MRI)"
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/Fetal-Echo.png"
        para="At Pathacon Diagnostics in Bangalore, we offer advanced MRI imaging for detailed views of soft tissues, including the brain, spine, and joints. Our expert team ensures accurate results for effective diagnosis and treatment."
      />
      <PathologyServiceCard
      ...
      <PathologyServiceCard
        ...
        img="https://nisargadiagnostics.com/wp-content/uploads/2023/12/Fetal-3D4D.png"
        para="This specialized ultrasound scan is used to diagnose injuries or conditions affecting the muscles, joints, ligaments, and tendons. Athletes and individuals with musculoskeletal pain can benefit from this Ultrasound Scan in Bangalore."
      />
    </div>
  );
};
