...
const EchoWho = () => {
  return (
    <div className="echoWho">
      <EchoWhoHeader
        head="Who Should Consider an ECHO Test in Rajajinagar, Bangalore?"
        para=" An ECHO Test in Rajajinagar, Bangalore is recommended for individuals
