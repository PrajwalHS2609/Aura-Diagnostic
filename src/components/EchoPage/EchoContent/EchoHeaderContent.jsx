  ...
  return (
    <div className="pathologyHeadContent">
      ...
      <p>
        ...
        abnormalities. The ECHO test, also known as an echocardiogram, uses
        ultrasound waves to create detailed images of the heart, allowing
        doctors to evaluate its structure and function in real-time.
      </p>
      <p>
...
export default EchoHeaderContent;
