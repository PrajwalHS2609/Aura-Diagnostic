...
const CardiologyHeaderContent = () => {
  return (
    <div className="pathologyHeadContent">
      ...
      <br />
      <h3> ChooseAura Diagnostics for Comprehensive Heart Health </h3>
      <p>
      ...
      <p>
        AtAura Diagnostics, we understand that early detection of
        ...
        specialized cardiac diagnostics,Aura Diagnostics has the expertise
