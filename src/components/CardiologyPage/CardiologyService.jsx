  ...
  return (
    <div className="pathologyService">
      ...
      <PathologyServiceCard
        ...
        img={StressTest}
        alt="StressTest"
        para="Also known as an exercise stress test, this cardiology test in Bangalore evaluates how your heart functions during physical activity. It helps determine whether your heart is receiving enough blood and oxygen when it’s working harder than normal. Stress tests are commonly used to detect coronary artery disease and assess your heart’s overall fitness level."
      />
      <PathologyServiceCard
        head="Holter Monitoring"
        img={HolterMonitoring}
        alt="HolterMonitoring"
        para="Holter monitoring is a cardiology test in Bangalore, where a small portable device records heart activity for 24 to 48 hours. It helps detect irregular heartbeats, arrhythmias, and other issues not visible during a standard ECG."
      />
      <PathologyServiceCard
        head="CT Scan"
        img={CTScan}
        alt="CTScan"
        para="A cardiac CT scan is a non-invasive cardiology test in Bangalore that uses advanced imaging technology to create detailed 3D images of your heart and its blood vessels. This test is highly effective in detecting coronary artery disease, identifying blockages, and assessing the risk of a heart attack."
      />
      <PathologyServiceCard
        head="MRI Scan"
        img={MRIScan}
        alt="MRIScan"
        para="A cardiac MRI is another sophisticated imaging test used to assess the structure and function of your heart. This cardiology test in Bangalore provides detailed images of the heart’s tissues, allowing your doctor to diagnose conditions such as heart disease, inflammation, and congenital heart defects."
      />
    </div>
  );
};
