      ...
      <div className="contentHead-wrapper">
        <div className="contentHead-content">
          ...
          <p>
            ...
            dating scan center Girinagar, Aura Diagnostics delivers precise
            ultrasound imaging in a safe, comfortable, and supportive
        ...
        <div className="contentHead-content">
          ...
          <p>
            ...
            pregnancy history requires careful monitoring.
          </p>
          <p>
            At Aura Diagnostics, our dating ultrasound scan Girinagar provides
            accurate measurements that help doctors assess fetal development and
            plan further prenatal care. Early dating scans also assist in
            identifying multiple pregnancies and ruling out complications at an
            early stage.
          </p>
        </div>
        {expanded && (
...
export default DatingScanContent;
