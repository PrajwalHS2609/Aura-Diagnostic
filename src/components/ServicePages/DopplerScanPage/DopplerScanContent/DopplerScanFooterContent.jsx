...
const DopplerScanFooterContent = () => {
  return (
    <div className="service-headContent">
      ...
      <p>
        A Doppler scan in Bangalore is a specialized ultrasound
      ...
      <p>
        The Doppler scan in Bangalore is essential in diagnosing a
      ...
      <p>
        <ul>
          ...
          <p>
            ...
            Doppler scan in Bangalore can help identify blockages
        ...
        <ul>
          ...
          <p>
            In pregnancy, a Doppler scan in Bangalore can be used
            ...
            there might be concerns about fetal growth or well-being.
          </p>
        </ul>
        <ul>
          <br />
          ...
          <p>
            ...
            Bangalore is invaluable in detecting abnormal blood
        ...
        <ul>
          ...
          <h6>5. Aneurysms:</h6>
          <p>
            A Doppler scan in Bangalore can detect aneurysms, which
      ...
      <p>
        ...
        <ul>
          ...
          <p>
            ...
            Bangalore. They work closely with referring physicians
      ...
      <p>
        A Doppler scan in Bangalore is a non-invasive procedure
...
export default DopplerScanFooterContent;
