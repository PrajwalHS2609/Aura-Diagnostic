  ...
  return (
    <div className="reviewsHead">
      ...
      <p>
        ...
        Testimonials” section, you’ll find expressions of trust, confidence, and
        appreciation from our valued patients, highlighting our dedication to
        delivering outstanding healthcare services.
      </p>
    </div>
  );
};
