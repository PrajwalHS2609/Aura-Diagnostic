...
export default function RootLayout({
  ...
  "@type": "MedicalService",
  "@id": "https://auradiagnostics.co.in/pregnancy-scans-in-girinagar-bangalore",
  "name": "Pregnancy & Fetal Scans in Girinagar, Bangalore",
  "description": "Comprehensive pregnancy scans and fetal scans in Girinagar, Bangalore including 3D & 4D fetal scans, NT scan, anomaly scan, growth scan with Doppler, fetal echocardiography, and fetal urosonogram for expecting mothers.",
  "serviceType": [
    "Pregnancy Scans",
    "Fetal Scans",
  ...
  "provider": {
    ...
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "1st floor, Above HDFC bank (Girinagar branch), #175, BBMP PID No. 41-137-175. 5th main road. Avalhalli extension. Banashankari 3rd stage",
  ...
  "availableService": [
    {
      ...
      "description": "Early pregnancy scan to confirm gestational age, fetal heartbeat, and viability."
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "Nuchal Translucency (NT) Scan in Girinagar",
      "description": "First trimester NT scan in Girinagar to assess risk of chromosomal abnormalities.",
      "procedureType": "Nuchal translucency scan in Girinagar"
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "Anomaly Scan (Level 2 Fetal Scan)",
      "description": "Detailed fetal anomaly scan in Girinagar to examine baby’s organs, limbs, and growth.",
      "procedureType": "Detailed anomaly scan Girinagar"
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "3D Fetal Scan in Bangalore",
      "description": "3D fetal scan for clear imaging of fetal features and development.",
      "procedureType": "3D fetal scan in Bangalore"
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "4D Fetal Scan in Bangalore",
      "description": "4D fetal scan to visualize real-time fetal movements and bonding experience.",
      "procedureType": "4D fetal scan in Bangalore"
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "Growth Scan with Doppler in Girinagar",
      "description": "Fetal growth scan with Doppler to monitor blood flow, placenta function, and baby’s well-being.",
      "procedureType": "Fetal Doppler scan in Girinagar"
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "Fetal Echocardiography in Girinagar",
      "description": "Detailed fetal heart scan to evaluate cardiac structure and function.",
      "procedureType": "Fetal Echocardiography in Girinagar"
    },
    {
      "@type": "DiagnosticProcedure",
      "name": "Fetal Urosonogram Test in Girinagar",
      "description": "Fetal renal and urinary tract scan to assess kidneys, bladder, and urinary system.",
